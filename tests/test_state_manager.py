...
class TestStateManager:
    ...
    def test_update_state_idle_to_nearby(self, state_manager, sample_truck, sample_point):
        state_manager.update_state(
            new_state="nearby", reason="Trash truck approaching", truck_line=sample_truck, enter_point=sample_point
        )
    ...
    def test_update_state_nearby_to_idle(self, state_manager, sample_truck, sample_point):
        state_manager.update_state(
            new_state="nearby", reason="Trash truck arrived", truck_line=sample_truck, enter_point=sample_point
        )

        state_manager.update_state(new_state="idle", reason="Trash truck left")
    ...
    def test_update_state_same_state(self, state_manager):
        ...
        state_manager.update_state(new_state="idle", reason="Maintain idle")
    ...
    def test_update_state_invalid_state(self, state_manager):
        with patch("src.core.state_manager.logger") as mock_logger:
            state_manager.update_state(new_state="invalid_state", reason="Test invalid state")

            assert state_manager.current_state == TruckState.IDLE
            mock_logger.error.assert_called_once()

    def test_get_status_response_idle(self, state_manager):
        state_manager.update_state(new_state="idle", reason="No trash trucks nearby")
    ...
    def test_str_representation(self, state_manager, sample_truck):
        ...
        state_manager.update_state(new_state="nearby", reason="Test", truck_line=sample_truck)
    ...
    def test_state_transition_with_partial_data(self, state_manager, sample_truck):
        state_manager.update_state(new_state="nearby", reason="Test partial data", truck_line=sample_truck)
    ...
    def test_multiple_state_changes(self, state_manager, sample_truck, sample_point):
        state_manager.update_state(
            new_state="nearby", reason="Enter collection point", truck_line=sample_truck, enter_point=sample_point
        )
        first_update = state_manager.last_update

        state_manager.update_state(new_state="idle", reason="Leave collection point")
        second_update = state_manager.last_update

        state_manager.update_state(new_state="nearby", reason="Enter again", truck_line=sample_truck)
    ...
    def test_concurrent_state_updates(self, state_manager, sample_truck):
        state_manager.update_state(new_state="nearby", reason="First update", truck_line=sample_truck)
        ...
        state_manager.update_state(new_state="nearby", reason="Second update", truck_line=new_truck)
